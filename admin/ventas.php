    ...
    select ventas.*, id_usuario,fecha,nombre,telefono,email,id_producto,cantidad
    from ventas,usuario,productos_venta")or die($conexion->error);
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#ventaModal">
            <i class="fa fa-bolt"></i> Agregar Nueva venta </button></div>
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
          ...
          <?php
                  ...
                  <tr>
                    ...
                    <td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Editar </button></td>
