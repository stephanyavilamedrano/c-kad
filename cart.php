        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row mb-5">
              ...
              <button class="btn btn-outline-dark btn-sm btn-block" onclick="window.location='cart.php'">Actualizar</button>
              </div>
              <div class="col-md-6">
              <button class="btn btn-outline-dark btn-sm btn-block" onclick="window.location='index.php'">Añadir mas productos</button>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <label class="text-black h4" for="coupon">Cupon de nuevo cliente</label>
                <p>Ingrese el codigo de su cupon</p>
              </div>
